...
public class NotificationMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            sendNotification(title, body, data.get("messageId"));
        }
     ...
     * @param messageId FCM message body received.
     */
    private void sendNotification(String title, String messageBody, String messageId) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.megaworxx_notification)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.megaworxx_notification))
